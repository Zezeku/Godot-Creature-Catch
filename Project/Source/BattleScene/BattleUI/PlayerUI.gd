...
func displayPlayerUI(player1, player2):
	...
	if creature1 != null:
		...
		creature1.get_child(0).frame = 2 ;
		creature1.scale = Vector2(1,1) ;
		creature1.visible = true ;
		creature1.position = Vector2(-10,60) ;
	...
	if creature2 != null:
		creature2.get_child(0).frame = 2 ;
		creature2.get_child(0).scale = Vector2(1,1) ;
		creature2.visible = true ;
		creature2.position = Vector2(-25,75) ;
